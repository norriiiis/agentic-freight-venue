...
export class CredentialIssuer {
  ...
  private mint(agentId: string, rec: NonNullable<ReturnType<MockRegistry["get"]>>, publicKey: OkpJwk, ev: { insuranceCheckedAt: string; vettingProvider: string; vettingFlags: string[]; proofOfControl: string }, now: Date, supersedes?: string): Credential {
