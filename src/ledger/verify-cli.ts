 ...
 * --regulator-key f[,id] pin an insurance regulator (repeatable): the filer's key must carry the regulator's signed word
 *                        that this licensed insurer files under it, checked here rather than trusted to the registries'
 *                        onboarding (FILER_UNLICENSED)
...
import type { FilerAttestation, InsurerAttestation, InsurerKey, RegistryAttestation, RegistryKey, RegulatorKey } from "../protocol/registry";
